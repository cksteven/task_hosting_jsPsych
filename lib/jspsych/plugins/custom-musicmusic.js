    ...
    */
    class CustomColorboardPlugin {
      ...
      @keyframes borderBlink {
        ...
        <div id="container">
        <button id="audio1" style="cursor: not-allowed;"; disabled> <img src="volume-icon.png" style="height:100px; width:100px"/> </button>
          <br />
          <br />
          <br />
        ...
        setTimeout(() => {
          document.getElementById("audio2").addEventListener("click", () => end_trial("left"));
          document.getElementById("audio3").addEventListener("click", () => end_trial("right"));
        }, 2000);
