    ...
    */
    class CustomColorboardPlugin {
      ...
      trial(display_element, trial) {
        ...
        // canvas.style = "image-rendering: -moz-crisp-edges;image-rendering: -webkit-crisp-edges;image-rendering: pixelated;image-rendering: crisp-edges;";
        // canvas.style.height = `${canvasHeight}px`;
        // // canvas.style.width = "800px";
        // canvas.style.width = `${parseInt(canvas.height * (canvas.clientWidth / canvas.clientHeight))}px`;
        ...
        // console.log("coords", trial.color_coords);
        // trial.color_coords
        // .filter((coord) => coord.column == 0 && coord.row == 0)
        // .forEach((coord) => {
        //   const curr_color = new Color("color(xyz-d65 " + this.xyY2XYZ(coord.x, coord.y, coord.Y).join(" ") + ")").to("srgb");
        //   ctx.strokeStyle = "rgba(0, 0, 0, 0)";
        //   ctx.fillStyle = `rgb(${curr_color.r * 256.}, ${curr_color.g * 256.}, ${curr_color.b * 256.})`;
        //   ctx.fillRect(0, 0, canvas.width, canvas.height);
        // });
        // // trial.color_coords
        // //   .filter((coord) => coord.column == 1 && coord.row == 2)
        // //   .forEach((coord) => {
        // //     const curr_color = new Color("color(xyz-d65 " + this.xyY2XYZ(coord.x, coord.y, coord.Y).join(" ") + ")").to("srgb");
        // //     ctx.fillStyle = `rgb(${curr_color.r * 256.}, ${curr_color.g * 256.}, ${curr_color.b * 256.})`;
        ...
        //     // ctx.shadowBlur = 0;
        //     ctx.fillRect(parseInt(col * length + (col - 1) * space), parseInt(row * length + (row - 1) * space), length, length);
        //   }
        // });
        // display_element.insertBefore(canvas, null);
        // // color(sRGB 0.41587 0.503670 0.36664);
        // const curr_color = new Color("color(xyz-d65 0.4 0.23 0.2)").to("srgb");
        // // console.log("sss", new Color("color(xyz-d65 0.4 0.23 0.2)").to("srgb"));
        // display_element.insertAdjacentHTML("beforeend", `<div style="background-color: rgb(${curr_color.r * 256.}, ${curr_color.g * 256.}, ${curr_color.b * 256.})">TEST</div>`);
        // display_element.insertAdjacentHTML("beforeend", `<div>TEST</div>`);
