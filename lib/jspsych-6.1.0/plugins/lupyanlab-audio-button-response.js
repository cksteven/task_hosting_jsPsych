...
jsPsych.plugins["lupyanlab-audio-button-response"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('lupyanlab-audio-button-response', 'stimulus', 'audio');

	plugin.info = {
		name: 'lupyanlab-audio-button-response',
		description: '',
		parameters: {
			stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // catch audio replay requests made using the R key
    ...
    function end_trial() {
      ...
      document.removeEventListener('keydown', check_key);
